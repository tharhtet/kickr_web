...
export default function StoreButtons({
  ...
  return (
    <div className={`flex flex-wrap gap-4 ${className}`}>
      <a
        href="#"
        className="flex items-center gap-3 rounded-lg bg-white px-6 py-3 text-ink ring-1 ring-black/5 shadow-[0_16px_36px_-18px_rgba(123,47,247,0.45)] transition hover:brightness-95"
      >
        <svg className="size-6 flex-none" viewBox="0 0 24 24" fill="none">
        ...
        <span className="leading-tight">
          <small className="block text-[0.6rem] font-medium uppercase tracking-wide text-[#6b7280]">
            Get it on
          </small>
          <strong className="block font-display text-[1rem] font-semibold">
            Google Play
          </strong>
        </span>
      </a>
      <a
        href="#"
        className={`flex items-center gap-3 rounded-lg px-6 py-3 shadow-[0_12px_28px_-12px_rgba(11,15,25,0.45)] transition ${appStoreClass}`}
      >
        <svg className="size-6 flex-none" viewBox="0 0 24 24" fill="currentColor">
        ...
        <span className="leading-tight">
          <small className="block text-[0.6rem] font-medium uppercase tracking-wide opacity-70">
            Download on the
          </small>
          <strong className="block font-display text-[1rem] font-semibold">
            App Store
